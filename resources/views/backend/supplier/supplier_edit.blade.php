                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <form method="post" action="{{ route('supplier.update')}}" id="myForm">
                            @csrf
                            <input name="id" value=" {{ $supplier->id }} " class="form-control" type="hidden">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="phone_number"  value=" {{ $supplier->phone_number }}" class="form-control" type="text">
                                </div>
                            </div>                        
                            <!-- end row -->
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="adress" value=" {{ $supplier->adress }}" class="form-control" type="text">
                                </div>
                            </div>                        
                            <!-- end row -->
